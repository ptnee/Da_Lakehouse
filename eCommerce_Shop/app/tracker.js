import { trackSelfDescribingEvent, enableActivityTracking, newTracker, trackPageView, setUserId, addGlobalContexts, removeGlobalContexts } from '@snowplow/browser-tracker';
import {
...
function CreatNewTracker() {
    ...
    console.log('nnneeeee', newTracker)
    enableActivityTracking({
        minimumVisitLength: 10,
        heartbeatDelay: 10
    });
    trackPageView()
    console.log('nnneeeee', trackPageView)
